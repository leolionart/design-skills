...
const themeSeeds: StyleSeed[] = [
  ...
  },
  {
    ...
    summary:
      "Typography does not just carry the content here — it becomes the main visual material, pulling the entire page into a very distinct voice.",
    ...
    supportingTreatments: ["expressive type pairing", "oversized headline"],
    imageryMode: "text as graphic form",
    avoidList: ["systems filled with tiny labels", "accessibility being treated as optional"],
    previewBullets: [
    ...
    keywords: ["typography first web design", "type led interface", "oversized headline ui", "expressive font pairing ui"],
    designPromptId: "bold-typography",
    vars: vars({
      "--theme-bg": "#f6f0eb",
      "--theme-bg-alt": "#ece3db",
      "--theme-surface": "rgba(255, 252, 248, 0.74)",
      "--theme-surface-strong": "#fffdfb",
      "--theme-text": "#1a1413",
      "--theme-muted": "#77655f",
      "--theme-border": "rgba(26, 20, 19, 0.12)",
      "--theme-accent": "#1a1413",
      "--theme-accent-2": "#9a6b55",
      "--theme-accent-contrast": "#fff9f6",
      "--theme-ring": "rgba(154, 107, 85, 0.24)",
      "--theme-shadow": "0 14px 30px rgba(53, 34, 28, 0.08)",
      "--theme-grid": "rgba(26, 20, 19, 0.05)",
      "--theme-radius": "18px",
      "--theme-font-display": "var(--font-editorial), Georgia, serif",
    }),
  },
  ...
  },
  {
    ...
    summary:
      "This variation leans heavily into stillness, white space, and slower reading rhythm. It is close to editorial minimalism, but emphasizes calmness, softness, and only a few precisely placed accents.",
    audience: "Wellness, architecture, boutique SaaS, premium services, founder brands",
    family: "editorial-typography",
    primaryLanguage: "calm typographic restraint",
    supportingTreatments: ["quiet spacing", "soft monochrome"],
    imageryMode: "cropped editorial still-life photography",
    avoidList: ["launch pages that need high energy", "very dense feature matrices"],
    previewBullets: [
      "Large white space with a small number of confident accents",
      "Imagery that leans toward still-life composition or refined crops",
    ...
    vars: vars({
      "--theme-bg": "#f4f1ea",
      "--theme-bg-alt": "#e6e0d5",
      "--theme-surface": "rgba(255, 252, 248, 0.8)",
      "--theme-surface-strong": "#fffdf9",
      "--theme-text": "#1d1b18",
      "--theme-muted": "#6f695f",
      "--theme-border": "rgba(29, 27, 24, 0.1)",
      "--theme-accent": "#7c8a74",
      "--theme-accent-2": "#b89a7f",
      "--theme-accent-contrast": "#1d1b18",
      "--theme-ring": "rgba(124, 138, 116, 0.22)",
      "--theme-shadow": "0 16px 30px rgba(69, 57, 45, 0.08)",
      "--theme-grid": "rgba(29, 27, 24, 0.05)",
      "--theme-radius": "24px",
      "--theme-font-display": "var(--font-editorial), Georgia, serif",
    }),
  },
