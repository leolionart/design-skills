...
const themeSeeds: StyleSeed[] = [
  ...
  },
  {
    ...
    vars: vars({
      ...
      "--theme-text": "#0f1a35",
      "--theme-muted": "#515e7d",
      "--theme-border": "rgba(15, 26, 53, 0.08)",
      "--theme-accent": "#4361ee",
      "--theme-accent-2": "#7209b7",
      "--theme-accent-contrast": "#ffffff",
      "--theme-ring": "rgba(67, 97, 238, 0.3)",
      "--theme-shadow": "0 10px 30px -10px rgba(15, 26, 53, 0.12), 0 4px 12px -4px rgba(15, 26, 53, 0.08)",
      "--theme-grid": "rgba(15, 26, 53, 0.04)",
      "--theme-radius": "24px",
    }),
  },
  {
