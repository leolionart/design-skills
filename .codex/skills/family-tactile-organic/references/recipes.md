...
## Exemplar chooser
- `claymorphism-soft-3d` -> use for puffy rounded surfaces, touchable softness, and playful material depth.
- `organic-mesh-gradients` -> use for ambient color fields, soft-futurist warmth, and gentler atmospheric branding.
...
- `organic-mesh-gradients` + editorial-typography for calmer premium softness
- `organic-mesh-gradients` + immersive-premium for one ambient hero field

## Escalation rule
Pick the source of softness first: cushioned materiality or atmospheric color field. Open only the matching exemplar pack after that distinction is clear.
